...
def _get_exportable_entities():
    ...
    from . import product_service, indication_service, challenge_service, technology_service, modality_service, facility_service, capability_service
    from ..models import Modality, ManufacturingEntity, ManufacturingCapability, Product, Indication, ManufacturingChallenge, ManufacturingTechnology
