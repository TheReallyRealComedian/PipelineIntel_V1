...
def data_export_page():
    """Page for exporting challenge data by modality."""
    page_context = export_service.get_export_page_context()

    context = {
        'title': "Challenge Data Export",
        'prepared_json': "{}",
        'total_tokens': 0,
    ...
    if request.method == 'POST':
        prepared_json, total_tokens = export_service.prepare_challenge_export(request.form)
